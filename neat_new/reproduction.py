...
from neat_new.config import ConfigParameter, DefaultClassConfig
from neat_new.math_util import mean
from neat_new.six_util import iteritems, itervalues
...
class DefaultReproduction(DefaultClassConfig):
    """
    Implements the default neat_new-python reproduction scheme:
