...
import time
import sys
from neat_new.math_util import mean, stdev
from neat_new.six_util import itervalues, iterkeys
...
class StdOutReporter(BaseReporter):
    ...
    def post_evaluate(self, config, population, species, best_genome):
        ...
        sids = list(iterkeys(species.species))
        for sid in sids:
            s = species.species[sid]
            print("{},{},{}".format(self.generation,sid,s.fitness),flush=True)
